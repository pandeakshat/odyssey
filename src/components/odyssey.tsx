...
export function odyssey_preface() {
    return (
...
export function odyssey_p_begin() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_one_research() {
return (
  <Card className="w-[350px]">
    <CardHeader>
...
export function odyssey_one_self_assess() {
return (
  <Card className="w-[350px]">
    <CardHeader>
...
export function odyssey_one_visualize() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_one_mindshift() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_one_action() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_one_evaluate() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_one_reminder() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_p_failure() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_two_canvas() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
...
export function odyssey_two_journal_one() {
  return (
    <Card className="w-[350px]">
      <CardHeader>
        <CardTitle>Chapter 2.1: Journal of a Failure </CardTitle>
        <CardDescription>Odyssey - Akshat Pande</CardDescription>
      </CardHeader>
      <CardContent>
          
          <div className="grid w-full items-center gap-4">
          <img src="odyssey_two_journal.png"></img>
          <Dialog>
              <DialogTrigger asChild>
                  <Button variant="outline">Read</Button>
              </DialogTrigger>
              <DialogContent className="">
                  ...
                  <ScrollArea className="h-[500px] w-[444px] rounded-md border p-4 overflow-auto">
                  A month and more since I wrote my last entry for my odyssey. <br /><br />

                  Odyssey is a book, a memoir, an autobiography of sorts. However, it is also a journey of every day with checkpoints, milestones, struggles and achievements. As such, it makes sense to me to have these journal entries for each chapter as I slowly unravel and take steps towards being more, the finished product can be more defined, however, it has never been about the finished product and how carefully crafted it looks, this is a journey from being something that I did not recognize and had to rip and tear to survive and become nothing to being somebody that I can be proud of when I look in the mirror. It is a journey and if anything, all journeys are filled with ups and downs that makes us not only question things but lose hope, gain hope, find peace, and deal with chaos sometimes.
                  <br /><br /> 
                  For the past month and more, I have managed to lose pretty much everyone close to me for a short time. The people I was truly vulnerable with or tried to be, or the people who I had feelings for and wanted to be with them in the future, or just people I had expectations for and desires or just a yearning for respect and being a choice, sometime. Not all of them were lost for long, some just worked out after a few days of silence back to normalcy, some have I think been lost for good, some are still there, but I know i have lost it, but I am glad they are a part, and more. It is the feeling of going through it all, of losing them and just waiting for their response and realizing, aah, it was just a facade, or one-sided efforts to keep something afloat, or whatever, I do not know the objective truth, and this is just the feeling I felt while losing them, so its just my truth, and it hurt. So, that affected me a bit to find any motivation or purpose to get better, I was just slowly suffocating on my own existence and blaming every part of me that exists.
                  <br /><br />
                  Another thing that happened recently was a person I knew, committed suicide. We were not really close but we had a few conversations and I did enjoy their company, we had plans to work on things together and I was excited for the same. However, I am not sure about how and why but after a day of conversation and us deciding to get back on a call in the next few days, she created a barrier between us, no response, no explanation, nothing. I did question a few times but that got ignored too. Me being me, understood during that time that it was something I did wrong, maybe I said something wrong, maybe she hates me now, maybe it is all my fault and I should not even reach out to people ever, or maybe something else happened that I was not sure about, either way, I apologised and said take care of yourself. Not even a few weeks after, I got to know that she committed suicide and that made me wonder if I could have done anything to be able to assist, maybe it is all my fault and I am currently speculating and wondering about the same.
                  <br /><br />
                  Continuing on the trend, the reason this is called an empty canvas of a failure is because its all encompassing, as such, I have been and continue to be a failure of a son. Given my age, I should be covering all financial responsibilities of the house, but I am not, I have failed and I am tired. I think what got to me was the conversation that was purely financial and how much I owe and how much is owed to me, and I thought, okay, that is all I am, and that is all I have defined by, so that is all I would leave it to. Not much explanation there, I hope the text is able to make you understand the context.
                  <br /><br />
                  Moving on, I do not have a dream, I have never had a dream from what I can remember, I keep going on and doing things but I do not ever know wanting to achieve something or being somewhere, I never tried to get the most marks or stand out or be the best, I just go with the flow, which would have been fine if I did not beat myself about not achieving anything either? I do not dream and I do not make efforts but I make sure to despise and self loathe myself when I am not able to get it either?? A bit stupid and dumb, but that is me. I have been going through life based on what other people may want, and defining my actions through them in a way, even though they are not always for them? It is my mind slowly constructing dialogues and reasoning where it loops around through someone else’s existence or conversation and not something I truly wanted? but somewhat I do. Like I do want things and I can feel that sometime but I do not feel comfortable having the feeling of wanting something so I just construct a story that loops around someone else and then feel that it is reasonable to act on? I do not know if this sounds funny or miserable or just an excuse butt that is how it is. An example that I came up with was robbing? Assuming I was planning to rob someone, or did rob someone, my mind would construct this dialogue that I did not want the money or the item, it would go more like, they have so much of it and they are probably finding it difficult to handle it all but do not want to burden anyone else with it either. I will assist them by taking some of it away without their consent so they do not feel the need to ask for help as they find it weird and they can just hate me for it but it will clear up their platter to manage what is left? I have caused issues in so much of my personal relationships with similar dialogues inside my mind, because I know I am downright horrible to be with. Most of the time, for sure.
                  <br /><br />
                  The point is, I do not have a dream, I have capability though, I can feel it, I have felt it, I can do so much and I am capable of great things, but I do not want anything so my body and mind just refuses to. It is like all of us are climbing this high rise building to get somewhere and I do not have a latch on anything, I am just going up when life demands it, otherwise I am just waiting or moving sideways or doing some tricks to appease my mind that life is going somewhere and it is not totally hopeless.
                  <br /><br />
                  So, I want a dream, I dont know how and if there is a sale going on, someone giving it away or its something you stumble upon or have to create. I do want something to dream.
                  <br /><br />
                  There are more things I want, but today, for now, will just clean up my environment again because its messy and it is affecting my mindset with everything else that has been happening, and just search for a dream. I do not know if it is going to be an external adventure or an internal introspection to dig out all I have buried long ago to belong and survive.
                  <br /><br />
                  </ScrollArea>
                  </DialogContent>
              </Dialog>
